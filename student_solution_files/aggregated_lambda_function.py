...
def lambda_handler(event, context):
    ...
    # dec_dict = {
    #             "name": "Reitumetse",
    #             "email": "reitu.pics@gmail.com",
    #             "phone": "0123",
    #             "message": "Hi Explore Data Science Student,\
    #                         \
...
"""
    ...
    table = dynamodb.Table('2401FTDE-REIRAM-portfolio-data-table')
    ...
    # --- Insert your code here ---
    critical_phrase_list = ['Article', 'posts', 'article', 'blogs', 'Articles', 'articles']
    # Do not change the name of this variable
    ...
    # --- Insert your code here ---
    SENDER = 'reitumetseramoeletsi@gmail.com'
    # -----------------------------
